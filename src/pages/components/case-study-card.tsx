...
const CaseStudyCard: React.FC<CaseStudyCardProps> = ({ study, index, isExpanded, onExpand }) => {
    ...
    const cardClassName = useMemo(() => {
        return `p-4 lg:p-8 rounded-lg border border-gray-300 cursor-pointer transition-all duration-300 ${
                ...
                <div className="flex flex-col items-start">
                    <div className="flex items-center">
                        <Link 
                            ...
                            className="text-xl lg:text-3xl font-bold hover:text-blue-600 transition-colors"
                        >
                            {study.title}
