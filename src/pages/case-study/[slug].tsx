...
const MarkdownComponents = {
  ...
  img: ({ node, src, alt, ...props }: { node: any; src: string; alt?: string; }) => {
    return (
      <>
        <motion.div 
          className="w-full h-[480px] relative my-8 group rounded-md border border-gray-300 cursor-zoom-in"
        ...
        >
          <Image 
            ...
            alt={alt || ''} 
            fill
            className="rounded-lg transition-all duration-300 group-hover:drop-shadow-2xl"
  ...
  // Style headings
  h1: (props: BaseProps) => <h1 className="text-4xl font-bold mt-8 mb-4" {...props} />,
  h2: (props: BaseProps) => <h2 className="text-3xl font-bold mt-8 mb-4" {...props} />,
  h3: (props: BaseProps) => <h3 className="text-2xl font-bold mt-6 mb-3" {...props} />,
    ...
    <>
      ...
      >
        <div className="max-w-4xl mx-auto px-8 py-20">
          ...
          >
            <h1 className="text-5xl font-bold mb-8">{study.title}</h1>
